...
///
/// author: bobo
/// create time: 2019/4/10 5:45 PM
/// email: jqbo84@163.com
///

void main() => runApp(AnimationBrickPage());

class AnimationBrickPage extends StatelessWidget {
  @override
...
class _HomePageState extends State<HomePage>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Animation Brick 示例'),),
      body: Center(
        child: Row(
